	...
	self.addEventListener('notificationclick', function(event) {
	  ...
	  const targetUrl = (event.notification && event.notification.data && event.notification.data.url) || '/tareas';
